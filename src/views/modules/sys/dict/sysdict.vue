  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="queryList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('business:sysdict:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" @click="editDictHandle(scope.row.id)">字典配置</el-button>
    ...
    <sys-dict-item v-if="sysDictItemVisible" ref="sysDictItem" @refreshDataList="getDataList"
                   :dictId="dictId"></sys-dict-item>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 字典配置
      editDictHandle(id) {
        this.sysDictItemVisible = true
        this.dictId = id
        this.$nextTick(() => {
          this.$refs.sysDictItem.getDataList(id)
        })
      },
      // 删除
      deleteHandle(id) {
